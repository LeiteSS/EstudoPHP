 ...
 class Mysql{
      ...
      */
        public function __construct($config == array()){
          ...
          $password = isset($config['password'])? $config['password'] : '71790909';
          $dbname = isset($config['dbname'])? $config['dbname'] : 'personalpost';
          $port = isset($config['port'])w $config['port'] : '3306';
       ...
       * @return $result, if succeed, return resources; if fail return error message and exit
       */
       ...
       * @access public
       * @param $sql string SQL query statement
       * @return return the value of this colum
       */
